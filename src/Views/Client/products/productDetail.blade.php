                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="{{ asset($product['img_thumbnail']) }}">
                                    ...
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <div class="flex-w flex-t p-b-68">
                                            <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                <img src="{{ asset('assets/client/images/avatar-01.jpg') }}"
                                                    alt="AVATAR">
                                            </div>
            ...
            <div class="wrap-slick2">
                <div class="slick2">
                                ...
                                <div class="block2-txt-child2 flex-r p-t-3">
                                    <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                        <img class="icon-heart1 dis-block trans-04"
                                            src="{{ asset('assets/client/images/icons/icon-heart-01') }}'"
                                            alt="ICON">
                                        <img class="icon-heart2 dis-block trans-04 ab-t-l"
                                            src="{{ asset('assets/client/images/icons/icon-heart-02') }}'"
                                            alt="ICON">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-02.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-03.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-04.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-05.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-06.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-07.jpg') }}" alt="IMG-PRODUCT">
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ asset('assets/client/images/product-08.jpg') }}" alt="IMG-PRODUCT">
