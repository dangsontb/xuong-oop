    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            ...
                            <a href="{{ url('products?category_id=1')}}"> Category </a>
                            <ul class="sub-menu">
                                @foreach ($categories as $category)
                                <li><a href="{{ url('products/category_id/'. $category['id'])}}">{{ $category['name'] }}</a></li>
                                @endforeach
                ...
                <button class="btn  dropdown-toggle dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 "
